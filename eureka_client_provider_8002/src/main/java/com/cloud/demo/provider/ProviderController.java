...
public class ProviderController {
    ...
    public Map<String,String> getInfo (){
        LOG.info("ProviderController-8002 提供服务");
        Map<String,String> infoMap = new HashMap<>() ;
        infoMap.put("主题：","SpringCloud微服务框架") ;
        infoMap.put("服务：","SProviderController-8002 提供服务") ;
        return infoMap ;
    }
    ...
    public String getAuthorInfo (@PathVariable("authorId") String authorId) {
        LOG.info("ProviderController-8002");
        return "SpringCloud微服务框架—8002—"+authorId ;
    }
}
